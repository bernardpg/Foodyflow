...
//                foodManager.deleteFood(foodId: <#T##String?#>, completion: <#T##(Result<String?, Error>) -> Void#>)
//                deleteFoodOnShoppingList(foodId: <#T##String#>, complection: <#T##() -> Void#>)
//                ShoppingListManager.shared.
